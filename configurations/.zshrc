...
local bs_dg="%K{8} %k"  # Block separator, [d]ark [g]rey.
local bs_lg="%K{15} %k" # Block separator, [l]ight [g]rey.
local ps_lg="%F{15}|%f"  # Pipe separator, [l]ight [g]rey.

local usr=' 👤 %n '
local clock=' 🕑 %* '
local dir=' 📁 %d '

precmd() { printf '\n'; print -rP "$bs_dg$bs_lg$usr$ps_lg$clock$ps_lg$dir$bs_lg$bs_dg" }
export PS1=" %F{4}%%%f "
